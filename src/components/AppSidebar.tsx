...
import {
  FileText, Clock, Star, Share2, Trash2, Settings, Shield, Tag, ChevronLeft,
} from 'lucide-react';
      ...
      <nav className="flex-1 overflow-y-auto px-2 py-2 space-y-0.5">
        ...
        {!collapsed && tags && tags.length > 0 && (
          <div className="mt-6 px-3">
            <p className="text-[10px] uppercase tracking-widest text-white/30 font-medium mb-2">Tags</p>
              ...
              {tags.map((tag) => {
                ...
                return (
                  <Link
                    ...
                    to={`/tag/${tag.id}`}
                    className={cn(
                      'flex items-center gap-2.5 py-1.5 text-sm transition-colors rounded px-1',
